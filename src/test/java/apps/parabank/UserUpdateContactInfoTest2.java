...
public class UserUpdateContactInfoTest2 extends CommonAPI {

    //39
    @Test
    public void updateContactInfoTest2() {
        ...
        driver.findElement(By.xpath("//*[@id=\"customer.address.zipCode\"]")).sendKeys("11433");
