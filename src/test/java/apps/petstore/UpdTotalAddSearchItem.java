...
public class UpdTotalAddSearchItem extends CommonAPI {
    @Test
    public void UpdTotalAddSearchItem() {
        ...
        waitFor(1);
        driver.findElement(By.cssSelector("input[name='keyword']")).sendKeys("persian");
