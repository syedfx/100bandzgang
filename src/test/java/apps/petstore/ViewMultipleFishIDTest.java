...
public class ViewMultipleFishIDTest extends CommonAPI {
    ...
    public void viewMultipleFishId() {
        ...
        click("a[href='/actions/Catalog.action?viewProduct=&productId=FI-SW-01']");
        click("a[href='/actions/Catalog.action?viewItem=&itemId=EST-1']");
        click("a[href='/actions/Catalog.action?viewProduct=&productId=FI-SW-01']");
        click("a[href='/actions/Catalog.action?viewItem=&itemId=EST-2']");
